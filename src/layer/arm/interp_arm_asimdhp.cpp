...
int Interp_arm::forward_fp16s(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
    ...
    if (dims == 2)
    {
        ...
        if (elempack == 4)
        {
            ...
            if (resize_type == 3) // bicubic
            {
                ...
                cubic_coeffs(w, outw, xofs, alpha, align_corner, (output_width || !size_expr.empty()) ? (double)w / outw : 1.0 / width_scale);
    ...
    if (elempack == 4)
    {
        ...
        if (resize_type == 2) // bilinear
        {
            ...
            linear_coeffs(w, outw, xofs, alpha, align_corner, (output_width || !size_expr.empty()) ? (double)w / outw : 1.0 / width_scale);
            linear_coeffs(h, outh, yofs, beta, align_corner, (output_height || !size_expr.empty()) ? (double)h / outh : 1.0 / height_scale);
        ...
        if (resize_type == 3) // bicubic
        {
            ...
            cubic_coeffs(w, outw, xofs, alpha, align_corner, (output_width || !size_expr.empty()) ? (double)w / outw : 1.0 / width_scale);
            cubic_coeffs(h, outh, yofs, beta, align_corner, (output_height || !size_expr.empty()) ? (double)h / outh : 1.0 / height_scale);
...
int Interp_arm::forward_fp16sa(const std::vector<Mat>& bottom_blobs, std::vector<Mat>& top_blobs, const Option& opt) const
{
    ...
    if (dims == 2)
    {
        ...
        if (elempack == 8)
        {
            ...
            if (resize_type == 2) // bilinear
            {
                ...
                linear_coeffs_fp16sa(w, outw, xofs, alpha, align_corner, (output_width || !size_expr.empty()) ? (double)w / outw : 1.0 / width_scale);
            ...
            if (resize_type == 3) // bicubic
            {
                ...
                cubic_coeffs_fp16sa(w, outw, xofs, alpha, align_corner, (output_width || !size_expr.empty()) ? (double)w / outw : 1.0 / width_scale);
    ...
    if (elempack == 8)
    {
        ...
        if (resize_type == 2) // bilinear
        {
            ...
            linear_coeffs_fp16sa(w, outw, xofs, alpha, align_corner, (output_width || !size_expr.empty()) ? (double)w / outw : 1.0 / width_scale);
            linear_coeffs_fp16sa(h, outh, yofs, beta, align_corner, (output_height || !size_expr.empty()) ? (double)h / outh : 1.0 / height_scale);
        ...
        if (resize_type == 3) // bicubic
        {
            ...
            cubic_coeffs_fp16sa(w, outw, xofs, alpha, align_corner, (output_width || !size_expr.empty()) ? (double)w / outw : 1.0 / width_scale);
            cubic_coeffs_fp16sa(h, outh, yofs, beta, align_corner, (output_height || !size_expr.empty()) ? (double)h / outh : 1.0 / height_scale);
